...
.directive('angularRte', function(paintService) {
  return {
	restrict: 'E',
	replace: true,
	scope: {content: '=textContent', trigger: '=submitTrigger'},
	templateUrl: 'static/partials/rte.html',
	...
	link: function(scope, element, attrs) {
		...
		// on clicking OK button if Ok button is inside the dirctive (it is not in hummuse!)
